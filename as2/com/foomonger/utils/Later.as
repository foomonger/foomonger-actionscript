...
class com.foomonger.utils.Later {
	...
	/**
	 *	Initialized data.  Run only the first time Later.call() is called.
	 */
	 ...
	 *	@param		(rest)		Additional arguments are passed to the given function.
	 ...
	 *	@returns	Object		An object that represents the given function.  Can be saved and passed to finish() and abort()
	 */
	public static function gcall(obj:Object, func:Function, duration:Number, useSeconds:Boolean, group:Number):Object {
		initialize();
	...
	public static function finish(laterObj:Object):Void {
		// if finish's caller was called Later.call()
	...
	public static function finishAll():Void {
		...
		for (name in __secondsData) {
			...
			// if finishAll's caller was called Later.call()
			if (arguments.caller == laterObj.func) {
